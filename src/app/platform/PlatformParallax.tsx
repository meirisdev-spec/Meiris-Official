...
export default function PlatformParallax({ platformModule }: Props) {
  ...
  // Fade in the mobile cards right after the title, before they start sliding
  const s3MobileCardsOp = isMobile ? lerp(0.176, 0.180) : 1;
  // Give more time to scroll (0.180 to 0.235)
  ...
  // Fade out so Section 8 can take over cleanly
        ...
        <div style={{ position: "sticky", top: 0, width: "100%", height: "100vh", zIndex: 0, backgroundColor: "#000", overflow: "hidden" }}>
          ...
          >
            <div className="mx-auto w-full max-w-[1180px] flex flex-col justify-center relative px-4 md:px-6 sm:px-8 py-6 md:py-8 lg:px-10">
              ...
              <div className="relative z-10 flex flex-col">
                ...
                >
                  <div className="shrink-0 w-[85vw] md:w-auto bg-[#2c2d2e] p-6 md:p-8 text-white rounded-[1rem] md:rounded-t-[1rem] md:rounded-tr-none md:rounded-l-[1.5rem] md:rounded-bl-[2rem]" style={{ opacity: isMobile ? s3MobileCardsOp : s3C1Op, transform: isMobile ? "none" : `translateY(${s3C1Y}px)` }}>
                    <h3 className="text-[13px] md:text-base font-semibold">Silicon Foundation</h3>
                    <p className="mt-2 md:mt-4 text-[10px] md:text-xs leading-[1.6] md:leading-relaxed text-white/50">SiC-based bidirectional power modules. Patented switching topologies. 30kW per module, scalable in parallel.</p>
                  </div>
                  <div className="shrink-0 w-[85vw] md:w-auto bg-[#2c2d2e] p-6 md:p-8 text-white rounded-[1rem] md:rounded-none" style={{ opacity: isMobile ? s3MobileCardsOp : s3C2Op, transform: isMobile ? "none" : `translateY(${s3C2Y}px)` }}>
                    <h3 className="text-[13px] md:text-base font-semibold">Control Architecture</h3>
                    <p className="mt-2 md:mt-4 text-[10px] md:text-xs leading-[1.6] md:leading-relaxed text-white/50">Proprietary SoC controller. DSP driven real-time switching. Multi module coordination and BMS communication.</p>
                  </div>
                  <div className="shrink-0 w-[85vw] md:w-auto bg-[#2c2d2e] p-6 md:p-8 text-white rounded-[1rem] md:rounded-b-[1rem] md:rounded-bl-none md:rounded-r-[1.5rem]" style={{ opacity: isMobile ? s3MobileCardsOp : s3C3Op, transform: isMobile ? "none" : `translateY(${s3C3Y}px)` }}>
                    <h3 className="text-[13px] md:text-base font-semibold">Firmware Intelligence</h3>
                    <p className="mt-2 md:mt-4 text-[10px] md:text-xs leading-[1.6] md:leading-relaxed text-white/50">Patented control algorithms. V2X energy routing. Grid demand response, ISO 15118, OCPP, and predictive management.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="mx-auto flex w-full max-w-[1240px] flex-col justify-center px-6 sm:px-10 lg:px-12">
              ...
              <div className="mt-4 md:mt-16 grid w-full grid-cols-1 gap-3 md:gap-6 md:grid-cols-2">
                <div className="rounded-[1rem] md:rounded-[1.5rem] border border-white/20 p-4 md:p-8" style={{ opacity: s5C1Op, transform: `translateX(${s5C1X}px)` }}>
                  <p className="text-[10px] md:text-[13px] leading-[1.4] md:leading-relaxed text-white/80">Bidirectionality is native to SiC devices. The same firmware that manages charging can manage discharge. There is no mode switch.</p>
                </div>
            ...
            <div className="mx-auto grid max-w-[1200px] grid-cols-1 items-center gap-4 md:gap-16 px-6 md:px-8 md:grid-cols-[1fr_1.1fr]">
              <div className="flex flex-col">
                <h2 className="text-[clamp(1.5rem,4vw,4rem)] font-bold leading-[1.05] tracking-tight text-white">
                  <TypewriterScroll text={"The firmware\nmakes the\nplatform\nwhat it is."} start={0.44} end={0.46} />
                </h2>
                <p className="mt-2 md:mt-12 max-w-sm text-[11px] md:text-[13px] leading-[1.4] md:leading-relaxed text-white/70">
                  <TypewriterScroll text={"The controller units built on a proprietary architecture and firmware form the intelligence layer that makes the platform coherent across all operating conditions, load profiles, and application contexts"} start={0.46} end={0.48} />
                </p>
                <p className="mt-2 md:mt-6 max-w-sm text-[11px] md:text-[13px] leading-[1.4] md:leading-relaxed text-white/70">
                  <TypewriterScroll text={"Patented firmware orchestrates real-time power control, dynamic load management, predictive energy optimization, and grid integration without middleware latency."} start={0.48} end={0.50} />
                </p>
              ...
              <div className="relative flex flex-col items-center mt-4 md:mt-0" style={{ opacity: s7ImgOp }}>
                ...
                <div className="mt-2 md:mt-6 flex w-full max-w-[500px] items-center justify-between">
                  <p className="text-[10px] md:text-sm text-white/80">MEIRIS Intelligence Core</p>
          ...
          <div style={{ position: "absolute", inset: 0, display: "flex", flexDirection: "column", justifyContent: isMobile ? "flex-start" : "flex-start", paddingTop: isMobile ? "90px" : "15vh", opacity: s8Op, willChange: "opacity" }}>
            <div className="mx-auto w-full max-w-[1200px] px-4 md:px-8" style={{ transform: `translateY(${s8PanY}vh)` }}>
              ...
              <div 
                className="mt-4 md:mt-16 flex md:grid flex-nowrap md:grid-cols-2 gap-4 md:gap-8 pb-6 md:pb-0 transition-transform duration-100 ease-out"
              ...
              >
                ...
                <div className="shrink-0 w-[85vw] md:w-auto relative aspect-[4/3] sm:aspect-square md:aspect-[5/4] overflow-hidden border border-white/10 rounded-2xl md:rounded-none" style={{ opacity: isMobile ? s8R1Op : s8R1Op, transform: isMobile ? "none" : `translateX(${s8C1X}px)` }}>
                  ...
                  <div className="absolute bottom-0 left-0 p-6 md:p-10 pointer-events-none">
                    ...
                    <p className="mt-2 text-[11px] md:text-[10px] text-white/80">DC Fast Chargers · AC Chargers · Onboard Chargers</p>
                  </div>
                </div>
                ...
                <div className="shrink-0 w-[85vw] md:w-auto relative aspect-[4/3] sm:aspect-square md:aspect-[5/4] overflow-hidden border border-white/10 rounded-2xl md:rounded-none" style={{ opacity: isMobile ? s8R1Op : s8R1Op, transform: isMobile ? "none" : `translateX(${s8C2X}px)` }}>
                  ...
                  <div className="absolute bottom-0 left-0 p-6 md:p-10 pointer-events-none">
                    ...
                    <p className="mt-2 text-[11px] md:text-[10px] text-white/80">High output (&gt;100 kVA) inverters</p>
                  </div>
                </div>
                ...
                <div className="shrink-0 w-[85vw] md:w-auto relative aspect-[4/3] sm:aspect-square md:aspect-[5/4] overflow-hidden border border-white/10 rounded-2xl md:rounded-none" style={{ opacity: isMobile ? s8R1Op : s8R2Op, transform: isMobile ? "none" : `translateX(${s8C3X}px)` }}>
                  ...
                  <div className="absolute bottom-0 left-0 p-6 md:p-10 pointer-events-none">
                    ...
                    <p className="mt-2 text-[11px] md:text-[10px] text-white/80">Traction inverters · Auxiliary converters</p>
                  </div>
                </div>
                ...
                <div className="shrink-0 w-[85vw] md:w-auto relative aspect-[4/3] sm:aspect-square md:aspect-[5/4] overflow-hidden border border-white/10 rounded-2xl md:rounded-none" style={{ opacity: isMobile ? s8R1Op : s8R2Op, transform: isMobile ? "none" : `translateX(${s8C4X}px)` }}>
                  ...
                  <div className="absolute bottom-0 left-0 p-6 md:p-10 pointer-events-none">
                    ...
                    <p className="mt-2 text-[11px] md:text-[10px] text-white/80">Power Conversion System (PCS)</p>
                  </div>
                </div>
              </div>
