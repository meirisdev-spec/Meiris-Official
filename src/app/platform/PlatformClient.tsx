...
export default function PlatformPage() {
  return (
    <div className="relative bg-black text-white">
      ...
      <section className="sticky top-0 min-h-screen flex flex-col justify-center bg-black py-24 overflow-hidden border-b border-white/10 shadow-[0_-20px_50px_rgba(0,0,0,0.5)]">
      ...
      <section className="sticky top-0 min-h-screen flex flex-col justify-center relative bg-black text-black overflow-hidden border-b border-white/10 shadow-[0_-20px_50px_rgba(0,0,0,0.5)]">
      ...
      <section className="sticky top-0 min-h-screen flex flex-col justify-center bg-black pt-24 pb-16 overflow-hidden border-b border-white/10 shadow-[0_-20px_50px_rgba(0,0,0,0.5)]">
        <div className="mx-auto max-w-[1200px] px-8">
      ...
      <section
        className="sticky top-0 min-h-screen flex flex-col justify-center py-32 overflow-hidden shadow-[0_-20px_50px_rgba(0,0,0,0.5)]"
        style={{
      ...
      <section className="sticky top-0 min-h-screen flex flex-col justify-center bg-black py-32 overflow-hidden shadow-[0_-20px_50px_rgba(0,0,0,0.5)]">
      ...
      <section className="sticky top-0 min-h-screen flex flex-col justify-center bg-black py-24 pb-32 overflow-hidden shadow-[0_-20px_50px_rgba(0,0,0,0.5)]">
        <div className="mx-auto max-w-[1200px] px-8">
